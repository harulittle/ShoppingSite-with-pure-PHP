<?php 
    ...
    // get monthly reports orders
        // select * from orders where date(order_date)> '2021-02-11' and date(order_date)< '2021-03-11'
  
        // minus 8 day in php;
    $fromDate=date('Y-m-d', strtotime('-1 months'));  //2021-02-11
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Monthly Reports Table</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
